...
Manager::Manager()
	: plugin::ComponentManager<file_analysis::Component>("Files", "Tag"),
...
bool Manager::AddAnalyzer(const string& file_id, const zeek::Tag& tag,
...
bool Manager::RemoveAnalyzer(const string& file_id, const zeek::Tag& tag,
                             RecordValPtr args) const
	{
	File* file = LookupFile(file_id);
...
File* Manager::GetFile(const string& file_id, Connection* conn, const zeek::Tag& tag,
